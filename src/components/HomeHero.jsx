...
const HeroSection = () => {
  return (
    <div className="relative mb-16 xs:mb-24 md:mb-32 drop-shadow-2xl">
        ...
        <div className="relative items-center justify-center">
          ...
          <div className="flex items-center justify-center scale-[.4] sm:scale-50 md:scale-[.6] lg:scale-75 xl:scale-110">
            <Image
              ...
              placeholder="blur"
              blurDataURL={
                'https://cms.ariscorp.de/assets/62eb0e48-6a0e-432f-b90d-fbd6aca6eaacjjjj?width=16&quality=1'
              }
              priority
            />
          </div>
