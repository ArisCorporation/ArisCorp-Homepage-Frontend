    ...
    >
      <div className="container px-4 mx-auto">
        ...
        <div className={showGer ? 'block' : 'hidden'}>
          <p className="italic">
            &ldquo;Diese Website wird nicht von oder der Unternehmensgruppe
            Cloud Imperium oder Roberts Space Industries geführt. Alle
            Spielinhalte und -materialien sind copyright Cloud Imperium Rights
            LLC und Cloud Imperium Rights Ltd. Star Citizen®, Squadron 42®,
            Roberts Space Industries® und Cloud Imperium® sind eingetragene
            Marken von Cloud Imperium Rights LLC. Alle Rechte
            vorbehalten.&rdquo;
          </p>
        </div>
        ...
        <div className={showGer ? 'hidden' : 'block'}>
          <p className="italic">
            &ldquo;This is an unofficial Star Citizen fansite, not affiliated
            with the Cloud Imperium group of companies. All content on this site
        ...
        <div className="flex float-right space-x-3">
          ...
          <a
            href="https://robertsspaceindustries.com/squadron42"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="https://cloudimperiumgames.com/"
            target="_blank"
            rel="noreferrer"
          >
