...
const TechCarrack = () => {
  ...
  return (
    <svg
      ...
      className="opacity-100 bg-[url('https://cms.ariscorp.de/assets/60ca623f-7a9b-4696-9839-97f9cde6e11d')] bg-no-repeat bg-cover"
      width="100%"
      height="100%"
    >
      {/* PROPULSION */}
      <g
        id="propulsiongroup"
        className={"transition-colors duration-200 fill-transparent hover:duration-300 hover:cursor-pointer " + (selectedTech == 'c5fba33f-9cdc-42b2-b601-6e7e6f59621b' ? 'fill-primary/70' : '')}
      ...
      <g
        id="cargogroup"
        className={"transition-colors duration-200 fill-transparent hover:duration-300 hover:cursor-pointer " + (selectedTech == 'e1c5e831-534e-473b-856b-bb8ba33655ac' ? 'fill-primary/70' : '')}
      ...
      <g
        id="fuelgroup"
        className={"transition-colors duration-200 fill-transparent hover:duration-300 hover:cursor-pointer " + (selectedTech == '07ff69e2-31b4-4fe6-ad09-3719a659aa51' ? 'fill-primary/70' : '')}
      ...
      <g
        id="livesupportgroup"
        className={"transition-colors duration-200 fill-transparent hover:duration-300 hover:cursor-pointer " + (selectedTech == '744474da-0797-4959-bb75-40edc134a607' ? 'fill-primary/70' : '')}
      ...
      <g
        ...
        className={"transition-colors duration-200 fill-transparent hover:duration-300 hover:cursor-pointer " + (selectedTech == '165f1bde-3678-4f85-bb8b-0e4c5e20e67f' ? 'fill-primary/70' : '')}
        onMouseEnter={() => setSelectedTech('165f1bde-3678-4f85-bb8b-0e4c5e20e67f')}
        onMouseLeave={() => setSelectedTech(undefined)}
        onClick={() =>
          router.push('/VerseExkurs/technologie/Quantum und Sprungantrieb')
        }
      >
        <path
          id="quantumjump1"
      ...
      <g
        id="computergroup"
        className={"transition-colors duration-200 fill-transparent hover:duration-300 hover:cursor-pointer " + (selectedTech == '1c44c62a-e1f6-4dfb-a907-90de864dde29' ? 'fill-primary/70' : '')}
      ...
      <g
        id="radargroup"
        className={"transition-colors duration-200 fill-transparent hover:duration-300 hover:cursor-pointer " + (selectedTech == '41db2450-c335-4bfb-bdc3-c21ca8c934e7' ? 'fill-primary/70' : '')}
      ...
      <g
        id="weapongroup"
        className={"transition-colors duration-200 fill-transparent hover:duration-300 hover:cursor-pointer " + (selectedTech == 'ac4583c6-8df9-4faf-97c6-0881eedf3afe' ? 'fill-primary/70' : '')}
      ...
      <g
        id="shieldgroup"
        className={"transition-colors duration-200 fill-transparent hover:duration-300 hover:cursor-pointer " + (selectedTech == '94cb2026-4b08-4f4e-b5cf-8a24574cf576' ? 'fill-primary/70' : '')}
      ...
      <g
        id="coolgroup"
        className={"transition-colors duration-200 fill-transparent hover:duration-300 hover:cursor-pointer " + (selectedTech == '691372da-bca6-4ca9-9bb8-2c7ddb28d928' ? 'fill-primary/70' : '')}
      ...
      <g
        id="ifcsgroup"
        className={"transition-colors duration-200 fill-transparent hover:duration-300 hover:cursor-pointer " + (selectedTech == '63d432e4-eafa-4ea1-9870-4610dd74d087' ? 'fill-primary/70' : '')}
      ...
      <g
        id="powerplantgroup"
        className={"transition-colors duration-200 fill-transparent hover:duration-300 hover:cursor-pointer " + (selectedTech == 'powerplant' ? 'fill-primary/70' : '')}
      ...
      <g
        ...
        className={"transition-colors duration-200 fill-transparent hover:duration-300 hover:cursor-pointer " + (selectedTech == 'grav' ? 'fill-primary/70' : '')}
