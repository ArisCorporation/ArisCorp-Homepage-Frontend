const TechCarrack = () => {
  return (
    ...
    <style>
      ...
      <path
        id="triebwerk1"
        className="fill-[#fe0101] propulsion"
      ...
      <path
        id="treibstoff27"
        className="fill-[#feaa01]"
        d="M234.91,220.16v3.68H208.17l-.2-3.68Z"
      />
      <path
        id="treibstoff28"
        className="fill-[#feaa01]"
      ...
      <path
        id="treibstoff31"
        className="fill-[#feaa01]"
        d="M1197,241l-1.24,1c-.26-.33-.51-.67-.76-1V205h2Z"
      />
      <path
        id="treibstoff32"
        className="fill-[#feaa01]"
      ...
      <path
        id="treibstoff33"
        className="fill-[#feaa01]"
        d="M240.83,240.91h-3.66V226.18l3.66-.21Z"
      />
      <path
        id="treibstoff34"
        className="fill-[#feaa01]"
        d="M305.83,240.91h-3.66V226.19l3.66-.23Z"
      />
      <path
        id="cool20"
        className="fill-[#02fe88]"
      ...
      <path
        id="treibstoff35"
        className="fill-[#feaa01]"
        d="M1207,235v6.91h-1.84V216.09H1207V235Z"
      />
      <path
        id="ifcs11"
        className="fill-[#6804fe]"
      ...
      <path
        id="treibstoff37"
        className="fill-[#feaa01]"
        d="M1329,207c0-1.43-.29-3,1.77-4H1341v4Z"
      />
      <path
        id="shields5"
        className="fill-[#249800]"
      ...
      <path
        id="treibstoff39"
        className="fill-[#feaa01]"
        d="M1226,220v19c-1.5-.09-.85-1.24-1-2V221Z"
      />
      <path
        id="cool24"
        className="fill-[#02fe88]"
        d="M694.1,433.82v-1.64h8.8v1.64Z"
      />
      <path
        id="cool25"
        className="fill-[#02fe88]"
        d="M727.09,433.83v-1.66h8.82v1.66Z"
      />
      <path
        id="cool26"
        className="fill-[#02fe88]"
        d="M716.1,433.82v-1.64h8.8v1.64Z"
      />
      <path
        id="cool27"
        className="fill-[#02fe88]"
        d="M705.09,433.83v-1.66h8.82v1.66Z"
      />
      <path
        id="cool28"
        className="fill-[#02fe88]"
        d="M683.1,433.82v-1.64h8.8v1.64Z"
      />
      <path
        id="cool29"
        className="fill-[#02fe88]"
        d="M746.91,432.17v1.66h-8.82v-1.66Z"
      />
      <ellipse
        className="fill-transparent"
        cx="1245.5"
      ...
      <path
        id="grav8"
        className="fill-[#fe0101]"
        d="M501,234v-4h1.45c.79,1.24,1.58,2.47,2.57,4Z"
      />
      <ellipse
        className="fill-transparent"
        cx="1207.5"
        ...
        ry="5.66"
      />
      <path id="grav9" className="fill-[#fe0101]" d="M481,254l-1,1Z" />
      <path id="grav10" className="fill-[#fe0101]" d="M500,235l1-1Z" />
      <path
        id="grav11"
        className="fill-[#fe0101]"
        d="M481,253l.83.67L481,254Z"
      />
      <path
        id="cool30"
        className="fill-[#02fe88]"
