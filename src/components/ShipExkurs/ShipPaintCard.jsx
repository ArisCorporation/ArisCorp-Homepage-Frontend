...
const ShipCard = ({ data }) => (
  <BasicPanel>
    <div className="h-[200px] relative transition-all duration-500 ease">
      <div className='relative block w-full h-full overflow-hidden bg-center bg-no-repeat bg-cover focus:outline-none group bg-white/5 rounded-2xl' style={{ backgroundImage: `url(https://cms.ariscorp.de/assets/${data.storeImage}?height=400)` }}>
