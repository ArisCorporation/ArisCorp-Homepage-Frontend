  ...
  return (
    <BasicPanel>
      <div className={'hardpointGroupInner'}>
        {data.hardpoints.filter((e) => e.type == 'cooler')[0] && (
              ...
              <div className={'hardpointItem'}>
                <div className={'hardpointItemQuantity'}>
                  <span>
                    {' '}
                    {
                      data.hardpoints.filter((e) => e.type == 'cooler').length
                    }{' '}
                  </span>
        ...
        {data.hardpoints.filter((e) => e.type == 'powerplant')[0] && (
          <div className={'hardpointType'}>
            <div className={'hardpointTypeLabel'}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <div className={'hardpointItem'}>
                <div className={'hardpointItemQuantity'}>
                  <span>
                    {' '}
                    {
                      data.hardpoints.filter((e) => e.type == 'powerplant')
                        .length
                    }{' '}
                  </span>
                  <span className="text-[#7c7c7c] lowercase">x</span>
        ...
        {data.hardpoints.filter(
          (e) => e.type == 'shield' || e.type == 'shieldgenerator'
        )[0] && (
          <div className={'hardpointType'}>
            <div className={'hardpointTypeLabel'}>
              <svg
                    ...
                    <div className={'hardpointItemInner'}>
                      <div className={'hardpointItemSize'}>
                        ...
                        Size{' '}
                        {
                          data.hardpoints.filter(
                            (e) =>
                              e.type == 'shield' || e.type == 'shieldgenerator'
                          )[0].size
                        }{' '}
                      </div>
                      {data.hardpoints.filter(
