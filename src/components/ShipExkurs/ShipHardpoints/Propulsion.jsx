              ...
              <div className={'hardpointItem'}>
                <div className={'hardpointItemQuantity'}>
                  <span>
                    {' '}
                    {
                      data.hardpoints.filter((e) => e.type == 'jumpmodule')
                        .length
                    }{' '}
                  </span>
                  <span className="text-[#7c7c7c] lowercase">x</span>
              ...
              <div className={'hardpointItem'}>
                <div className={'hardpointItemQuantity'}>
                  <span>
                    {' '}
                    {
                      data.hardpoints.filter((e) => e.type == 'quantumdrive')
                        .length
                    }{' '}
                  </span>
                  <span className="text-[#7c7c7c] lowercase">x</span>
              ...
              <div className={'hardpointItem'}>
                <div className={'hardpointItemQuantity'}>
                  <span>
                    {' '}
                    {
                      data.hardpoints.filter((e) => e.type == 'quantumfueltank')
                        .length
                    }{' '}
                  </span>
                  <span className="text-[#7c7c7c] lowercase">x</span>
