...
const Thruster = ({ data, components }) => {
  ...
  if(!data.hardpoints.filter((e) => e.type == 'mainthruster' || e.type == 'retrothruster' || e.type == 'vtolthruster' || e.type == 'fixedmaneuveringthruster' || e.type == 'gimbaledmaneuveringthruster')[0]) {
    return
  }
