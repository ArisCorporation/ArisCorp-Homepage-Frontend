...
const CommLinksSection = () => {
  ...
  return (
    <div className="flex flex-wrap justify-center my-12">
      <ThreeThirds typeicon="type-post" typename="post" image="bg-[url('//cms.ariscorp.de/assets/f74509b5-5ed8-4965-9d1a-0f17b9e12736')]" title="This Week in Star Citizen" channel="Monthly Report" posted="1 day ago" description="dsajkldsahjlkdsl" />
    </div>
  );
};
  ...
  return (
    <Link href="/">
      <a className="mt-10 mr-[30px] lg:w-[729px] h-[315px] block p-[10px] float-left border-[1px] border-primary boder-solid border-opacity-20 relative box-content group cursor-pointer">
        ...
        <div className="w-[338px] h-[315px] lg:w-[729px] lg:h-[315px] transition-opacity duration-200 opacity-0 group-hover:opacity-100 bg-lines absolute overflow-hidden z-10 top-[10px]">
