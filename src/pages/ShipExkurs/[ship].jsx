                    ...
                    <BasicPanel>
                      <div className={"hardpointGroupInner"}>
                        <div className={"hardpointType"}>
                          ...
                          <div className={"hardpointItems"}>
                            {data.hardpoints.filter((e) => e.type == 'mainthruster')[0] && (
                              <div className={"hardpointItem"}>
                                <div className={"hardpointItemQuantity"}>
                                  <span> {data.hardpoints.filter((e) => e.type == 'mainthruster').length} </span>
                                  <span className='text-[#7c7c7c] lowercase'>x</span>
                                </div>
                                <div className={"hardpointItemSlots"}>
                                  <div className={"hardpointItemSlot"}>
                                    <div className={"hardpointItemInner"}>
                                      <div className={"hardpointItemSize"}> Size {(data.hardpoints.filter((e) => e.type == 'mainthruster')[0].size)} </div>
                                      <div className={"hardpointItemComponent"}>Main Thruster</div>
                                      <Link href={'/VerseExkurs/firmen/' + data.manufacturer.firmen_name} className={'hardpointItemComponentManufacturer text-inherit decoration-transparent hover:text-white transition-all duration-300 hover:duration-150'}>{data.manufacturer.firmen_name}</Link>
                                    </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            {data.hardpoints.filter((e) => e.type == 'retrothruster')[0] && (
                              <div className={"hardpointItem"}>
                                <div className={"hardpointItemQuantity"}>
                                  <span> {data.hardpoints.filter((e) => e.type == 'retrothruster').length} </span>
                                  <span className='text-[#7c7c7c] lowercase'>x</span>
                                </div>
                                <div className={"hardpointItemSlots"}>
                                  <div className={"hardpointItemSlot"}>
                                    <div className={"hardpointItemInner"}>
                                      <div className={"hardpointItemSize"}> Size {(data.hardpoints.filter((e) => e.type == 'retrothruster')[0].size)} </div>
                            ...
                            {data.hardpoints.filter((e) => e.type == 'vtolthruster')[0] && (
                              <div className={"hardpointItem"}>
                                <div className={"hardpointItemQuantity"}>
                                  <span> {data.hardpoints.filter((e) => e.type == 'vtolthruster').length} </span>
                                  <span className='text-[#7c7c7c] lowercase'>x</span>
                                </div>
                                <div className={"hardpointItemSlots"}>
                                  <div className={"hardpointItemSlot"}>
                                    <div className={"hardpointItemInner"}>
                                      <div className={"hardpointItemSize"}> Size {(data.hardpoints.filter((e) => e.type == 'vtolthruster')[0].size)} </div>
                        ...
                        <div className={"hardpointType"}>
                          ...
                          <div className={"hardpointItems"}>
                            {data.hardpoints.filter((e) => e.type == 'fixedmaneuveringthruster')[0] && (
                              <div className={"hardpointItem"}>
                                <div className={"hardpointItemQuantity"}>
                                  <span> {(data.hardpoints.filter((e) => e.type == 'fixedmaneuveringthruster').length) + data.hardpoints.filter((e) => e.type == 'gimbaledmaneuveringthruster').length} </span>
                                  <span className='text-[#7c7c7c] lowercase'>x</span>
                                </div>
                                <div className={"hardpointItemSlots"}>
                                  <div className={"hardpointItemSlot"}>
                                    <div className={"hardpointItemInner"}>
                                      <div className={"hardpointItemSize"}> Size {(data.hardpoints.filter((e) => e.type == 'fixedmaneuveringthruster')[0].size)} </div>
                                      <div className={'hardpointItemComponent text-sm'}>Fixed Manöver Triebwerke</div>
                                      <Link href={'/VerseExkurs/firmen/' + data.manufacturer.firmen_name} className={'hardpointItemComponentManufacturer text-inherit decoration-transparent hover:text-white transition-all duration-300 hover:duration-150'}>{data.manufacturer.firmen_name}</Link>
                                    </div>
                                  </div>
                                </div>
                            ...
                            {data.hardpoints.filter((e) => e.type == 'gimbaledmaneuveringthruster')[0] && (
                              <div className={"hardpointItem"}>
                                <div className={"hardpointItemQuantity"}>
                                  <span> {(data.hardpoints.filter((e) => e.type == 'gimbaledmaneuveringthruster').length) + data.hardpoints.filter((e) => e.type == 'gimbaledmaneuveringthruster').length} </span>
                                  <span className='text-[#7c7c7c] lowercase'>x</span>
                                </div>
                                <div className={"hardpointItemSlots"}>
                                  <div className={"hardpointItemSlot"}>
                                    <div className={"hardpointItemInner"}>
                                      <div className={"hardpointItemSize"}> Size {(data.hardpoints.filter((e) => e.type == 'gimbaledmaneuveringthruster')[0].size)} </div>
                                      <div className={'hardpointItemComponent text-sm'}>Gimbaled Manöver Triebwerke</div>
                                      <Link href={'/VerseExkurs/firmen/' + data.manufacturer.firmen_name} className={'hardpointItemComponentManufacturer text-inherit decoration-transparent hover:text-white transition-all duration-300 hover:duration-150'}>{data.manufacturer.firmen_name}</Link>
                                    </div>
                                  </div>
                                </div>
