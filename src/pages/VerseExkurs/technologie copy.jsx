    ...
    <>
      <div className="pt-10 mx-auto print:pt-5 prose prose-td:align-middle prose-invert xl:max-w-[90%]">
        <div className="relative hidden xl:block">
          <div
            key={data.id}
            className="absolute w-full h-28 lg:right-0 top-46 sm:top-44 md:top-52 lg:top-48 xl:-top-4 2xl:h-32 lg:w-60 xl:w-60 2xl:w-64 md:bg-gray-800/50 propulsion-popup"
          >
            <div className="md:w-full mx-auto h-full w-[80%] md:bg-transparent bg-gray-800/50">
              <div className="flex flex-wrap justify-center text-center">
                <h5>Triebwerke</h5>
                <div className="bg-red-800 relative sm:w-64 md:w-72 lg:w-52 2xl:w-56 sm:h-[4.6rem] 2xl:h-[5.5rem] mx-auto">
                  <Image
                    src={
                ...
                <div>
                  <p>Hier werden die Funktionen der Frachträume und die Verwendung der Frachcontainer vermittelt.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="relative hidden sm:block xl:hidden">
          <div
            key={data.id}
            className="absolute w-full h-28 lg:right-0 2xl:h-32 lg:w-60 xl:w-60 2xl:w-64 md:bg-gray-800/50 propulsion-popup"
          >
            <div className="md:w-full mx-auto h-full w-[80%] md:bg-transparent bg-gray-800/50">
              <div className="flex flex-wrap justify-center text-center">
                <h5>Triebwerke</h5>
